...
# ЗАДАНИЕ 2: Таблица таблиц и их главных (первичных) ключей
...
Эту таблицу можно составить двумя способами: автоматически (через быстрый запрос) и вручную.
...
После того как мы правильно перенастроили безопасность, команда `SHOW GRANTS` вывела на экран две строки. :
